...
static constexpr auto qt_meta_stringdata_CLASSprofileENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_authenicationPROFILE_clicked",
    "on_walletPROFILR_clicked"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSprofileENDCLASS_t qt_meta_stringdata_CLASSprofileENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 23),  // "on_guidePROFILE_clicked"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 31),  // "on_authenicationPROFILE_clicked"
        QT_MOC_LITERAL(65, 24)   // "on_walletPROFILR_clicked"
    },
    "profile",
    "on_guidePROFILE_clicked",
    "",
...
Q_CONSTINIT const QMetaObject profile::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSprofileENDCLASS_t,
        ...
        // method 'on_authenicationPROFILE_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_walletPROFILR_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void profile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_guidePROFILE_clicked(); break;
        case 1: _t->on_authenicationPROFILE_clicked(); break;
        case 2: _t->on_walletPROFILR_clicked(); break;
        default: ;
        }
    }
    (void)_a;
